...
def setup_paths(name, base_dir=None, create_dirs=True) -> Dict[str, Path]:
    ...
    """
    if base_dir is None:
        base_dir = Path('/Users/boccardpierre/Documents/PhD/Research/Code/VoidX_voronoi/data')
    else:
    ...
    galaxy_info_dir = data_dir / 'galaxy_info_files'
